...
func (x *drpcRemote_ReceiveClient) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcRemote_ReceiveClient) Send(m *Packet) error {
	return x.MsgSend(m, drpcEncoding_File_remote_proto{})
}

func (x *drpcRemote_ReceiveClient) Recv() (*Packet, error) {
	m := new(Packet)
...
func (x *drpcRemote_ReceiveClient) RecvMsg(m *Packet) error {
...
func (x *drpcRemote_ReceiveStream) Send(m *Packet) error {
	return x.MsgSend(m, drpcEncoding_File_remote_proto{})
}

func (x *drpcRemote_ReceiveStream) Recv() (*Packet, error) {
	m := new(Packet)
	if err := x.MsgRecv(m, drpcEncoding_File_remote_proto{}); err != nil {
		return nil, err
	}
...
func (x *drpcRemote_ReceiveStream) RecvMsg(m *Packet) error {
	return x.MsgRecv(m, drpcEncoding_File_remote_proto{})
}
