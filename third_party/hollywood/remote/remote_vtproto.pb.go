...
func (x *remoteReceiveClient) Send(m *Packet) error {
	return x.ClientStream.SendMsg(m)
}

func (x *remoteReceiveClient) Recv() (*Packet, error) {
	m := new(Packet)
...
func (x *remoteReceiveServer) Send(m *Packet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *remoteReceiveServer) Recv() (*Packet, error) {
	m := new(Packet)
